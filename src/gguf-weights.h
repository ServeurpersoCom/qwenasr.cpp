...
//
// GGUF weight loader for all qwenasr components (conv stem, audio encoder,
// Qwen3 Thinker decoder, BPE tokenizer). All components use GGUF BF16 files
...
// Useful for CPU-side operations (e.g. bf16 token embed lookup).
